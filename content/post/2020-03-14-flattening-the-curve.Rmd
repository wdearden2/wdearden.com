...
So we can see a strong effect from changing behavior, especially in the peak number of people infected. Another cool thing about this model is we can estimate the number of people who will eventually get COVID-19 if this model's dynamics hold.
