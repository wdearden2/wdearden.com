...
Note that the results of this model will depend on the fact that the disease has already spread somewhat to both populations. If one population doesn't have the disease at all, then of course completely stopping all travel to that country will stop it from getting the disease. This the approach that [Micronesia has taken](https://slate.com/technology/2020/03/micronesia-drastic-coronavirus-travel-ban.html).
