...
The effect of banning international travel is the shift from solid lines to dashed lines, which is minimal. The reason is that it has already spread to the United States. Even though other countries have a head start, allowing travel only shifts the trajectory of the disease spread up a few days.
